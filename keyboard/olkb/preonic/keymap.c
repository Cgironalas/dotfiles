 ...
 * |------------+-------+-------+-------+-------+-----+-----+-------+-------+-------+-------+-------|
 * | FN/ESC     | R_Alt |  GUI  |  Alt  | Lower |   Space   | Raise | Left  | Down  |  Up   | Right |
 * `------------------------------------------------------------------------------------------------'
 */
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_RCTL, _______, KC_PIPE, KC_PLUS, KC_UNDS, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL,  KC_BSLS, _______, _______, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  KC_TILD, KC_EXLM,   KC_AT, KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,  \
  KC_RCTL, _______, KC_BSLS, KC_EQL,  KC_MINS, KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS, KC_PIPE, _______, _______, \
  KC_LSFT, _______, _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, _______, KC_RSFT, \
  _______, _______, _______, _______, _______, KC_ENT,  KC_ENT,  _______, _______, _______, _______, _______  \
),
